...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            implementation_files=[
                repo_root / "weights" / "gen13_tens18_170_4_hardened.ts",
            ...
            defaults={
                "model_name": "poker44_ml13tens18",
                "model_version": "13.18",
                "framework": "pytorch-torchscript",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-ml13tens18",
                "repo_commit": git_commit,
                "notes": "Gen13Tens18 neural network scorer (POT=170, AAF=4)",
                "open_source": True,
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        synapse.predictions = [s >= 0.4 for s in scores]
        ...
        bt.logging.info(f"Scored {len(chunks)} chunks with scorer ml13tens18.")
        return synapse
...
if __name__ == "__main__":
    ...
    with Miner() as miner:
        ...
        while True:
            bt.logging.info(
                f"Miner UID: {miner.uid} | Incentive: {float(miner.metagraph.I[miner.uid])} | Scorer: ml13tens18"
            )
            time.sleep(60)
